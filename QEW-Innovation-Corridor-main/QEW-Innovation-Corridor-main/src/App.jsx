...
import { getCameraImages, getCollectionTimestamp } from './utils/cameraImageUtils';
...
function App() {
  ...
  // QEW route polyline - Following real MTO COMPASS camera locations
  const qewPath = [
    QEW_ROUTE.burlington,      // Highway 403/407 junction
    [43.350991, -79.804387],   // Guelph Line
    [43.365999, -79.787822],   // Walkers Line
    [43.380567, -79.771857],   // Appleby Line
    [43.39482, -79.756279],    // Burloak Drive
    [43.409256, -79.740829],   // Bronte Road
    [43.423658, -79.724908],   // Third Line
    [43.437966, -79.709307],   // Fourth Line
    [43.453417, -79.691777],   // Dorval Drive
    [43.460956, -79.683623],   // Trafalgar Road
    [43.509095, -79.663153],   // Winston Churchill
    [43.535794, -79.634228],   // Erin Mills Parkway
    [43.550471, -79.617523],   // Mississauga Road
    [43.5700, -79.5900],       // Mavis Rd area
    [43.5900, -79.5800],       // Dixie Rd area
    [43.6100, -79.5600],       // Cawthra Rd area
    [43.6250, -79.5350],       // Etobicoke Creek area
    [43.6350, -79.5000],       // Islington Ave area
    [43.6370, -79.4650],       // Kipling Ave area
    [43.6380, -79.4250],       // Park Lawn Rd area
        ...
        <div className="w-2/3 relative">
          ...
          >
            ...
            {COMPASS_CAMERAS.map(camera => {
              const cameraImages = getCameraImages(camera.id);
              return (
                <Marker
                  key={camera.id}
                ...
                >
                  <Popup maxWidth={400} minWidth={300}>
                    <div className="text-sm">
                      <strong className="text-base">{camera.name}</strong><br />
                      <span className="text-gray-600">Camera ID: {camera.id}</span><br />
                      <span className="text-green-600">Status: {camera.status}</span><br />
                      ...
                      {cameraImages.length > 0 && (
                        <div className="mt-3">
                          <div className="text-xs text-gray-500 mb-1">
                            Latest Images (Captured: {getCollectionTimestamp()})
                          </div>
                          <div className="space-y-2">
                            {cameraImages.map((imgPath, idx) => (
                              <div key={idx} className="border rounded overflow-hidden">
                                ...
                                />
                                <div style={{display: 'none'}} className="p-2 bg-gray-100 text-xs text-gray-500">
                                  Image not available
                                </div>
                              </div>
                            ))}
